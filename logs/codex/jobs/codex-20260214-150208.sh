...
PROMPT=test\ missing\ codex\ bin\ should\ fail\ status
JOB_JSON=/home/ubuntu/.openclaw/workspace/logs/codex/jobs/codex-20260214-150208.json
JOB_ID=codex-20260214-150208
...
if obj["lastMsg"] and Path(obj["lastMsg"]).exists():
    obj["status"] = "done"
