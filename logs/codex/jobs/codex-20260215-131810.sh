...
PROMPT=Run\ openclaw\ update.run\ to\ upgrade\ the\ gateway\ and\ CLI\ to\ the\ latest\ release\ \(currently\ v2026.2.14\)\,\ then\ report\ the\ outcome.
JOB_JSON=/home/ubuntu/.openclaw/workspace/logs/codex/jobs/codex-20260215-131810.json
JOB_ID=codex-20260215-131810
